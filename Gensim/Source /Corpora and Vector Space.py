...
corpora.MmCorpus.serialize('/Users/JimberXin/Documents/Github Workingspace/'
                           'Natural-Language-Programming/Gensim/Corpus/FirstCorpus.mm', corpus)
"""
...
dictionary_memory_friendly = corpora.Dictionary(line.lower().split() for line in open(
    '/Users/JimberXin/Documents/Github Workingspace/'
    'Natural-Language-Programming/Gensim/Corpus/mycorpus.txt'))
